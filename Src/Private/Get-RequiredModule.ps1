function Get-RequiredModule {
    ...
    if ($ModuleVersion -eq ".") {
        throw "VMware PowerCLI $Version or higher is required to run the VMware UAG As Built Report. Run 'Install-Module -Name $Name -MinimumVersion $Version' to install the required modules."
    }
